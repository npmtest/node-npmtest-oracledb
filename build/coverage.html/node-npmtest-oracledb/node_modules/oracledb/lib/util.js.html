...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-oracledb/node_modules/oracledb/lib/util.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-oracledb/node_modules/oracledb/lib/util.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-oracledb/node_modules/oracledb/lib/</a> &#187; util.js</div>
</div>
<div class="body">
...
// inheritance.
<span class="fstat-no" title="function not covered" >function makeEventEmitter(instance){</span>
<span class="cstat-no" title="statement not covered" >  eventEmitterFuncKeys.forEach(<span class="fstat-no" title="function not covered" >function(key) {</span></span>
<span class="cstat-no" title="statement not covered" >    instance[key] = EventEmitter.prototype[key];</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  EventEmitter.call(instance);</span>
}
&nbsp;
...
function getErrorMessage(errorCode, messageArg1) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (messageArg1) {
<span class="cstat-no" title="statement not covered" >    return util.format(errorMessages[errorCode], messageArg1);</span>
  } else {
...
<span class="fstat-no" title="function not covered" >function assert(condition, errorCode, messageArg1) {</span>
<span class="cstat-no" title="statement not covered" >  if (!condition) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error(getErrorMessage(errorCode, messageArg1));</span>
  }
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (!self._oracledb.Promise || typeof arguments[arguments.length - 1] === 'function') {</span>
<span class="cstat-no" title="statement not covered" >      return func.apply(self, arguments);</span>
    } else {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return new self._oracledb.Promise(<span class="fstat-no" title="function not covered" >function(resolve, reject) {</span></span>
<span class="cstat-no" title="statement not covered" >        var errorCode;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        try {</span>
<span class="cstat-no" title="statement not covered" >          args[args.length] = <span class="fstat-no" title="function not covered" >function(err, result) {</span></span>
...
<span class="cstat-no" title="statement not covered" >          errorCode = err.message.substr(0, 7);</span>
&nbsp;
          // Check for invalid number or type of parameter(s) as they should be
          // eagerly thrown.
<span class="cstat-no" title="statement not covered" >          if (errorCode === 'NJS-009' || errorCode === 'NJS-006') {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function isObjectOrArray(value) {</span>
<span class="cstat-no" title="statement not covered" >  return (value !== null &amp;&amp; typeof value === 'object') || Array.isArray(value);</span>
}
&nbsp;
